...
type option struct {
	RegistryAddr    string `valid:"ascii,required"`
	Name            string
	PlatName        string   `valid:"ascii,required"`
	SystemName      string   `valid:"ascii,required"`
	ServerTypeNames string   `valid:"ascii,required"`
