...
type watchPath struct {
	updater       chan []*service.ServiceUpdater
...
func NewWatchPath(domain string, tag string, path string, registry Registry, updater chan []*service.ServiceUpdater, timeSpan time.Duration) *watchPath {
	return &watchPath{
