...
配置服务器运行参数(端口，路由规则，安全认证等)可以使用themis图形界面进行操作，也可以使用zooInspector手动编写json代码,如果还没安装,请点击这里[安装themis](https://github.com/qxnw/hydra/blob/master/quickstart/5.install_themis.md) 
