...
###    run 命令
`new` 命令是监控指定项目的文件变化，变化后自动编译并重新启动项目。在命令行下执行 `gaea run <hydra启动命令> -w <项目名称>` 
...
[2017/10/31 17:11:48.774768][i][d07dc9004]notify(api):静态文件未配置:未配置,false
[2017/10/31 17:11:48.781323][i][d07dc9004]notify(api):启用metric
...
[2017/10/31 17:11:49.292769][i][c178f34d3]notify(rpc):启用metric
