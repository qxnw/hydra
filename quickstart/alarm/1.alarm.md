...
|名称|服务名|args参数
|----|-----|----|
|CPU使用率|/alarm/collect/cpu/used|influxdb:数据库配置|
|内存使用率|/alarm/collect/mem/used|influxdb:数据库配置|
|硬盘使用率|/alarm/collect/disk/used|influxdb:数据库配置|
|网络连接数|/alarm/collect/net/conn|influxdb:数据库配置|
|网络收发数|/alarm/collect/net/status|influxdb:数据库配置|
...
|nginx错误数|/alarm/collect/api/server/response|influxdb:数据库配置|
|nginx每秒请求数|/alarm/collect/api/server/response|influxdb:数据库配置|
