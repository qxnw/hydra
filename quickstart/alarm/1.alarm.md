...
|名称|服务名|args参数
|----|-----|----|
|CPU使用率|/alarm/collect/cpu/used|influxdb:数据库配置,max:CPU最高使用比例0-100|
|内存使用率|/alarm/collect/mem/used|influxdb:数据库配置,max:内存最高使用比例0-100|
|硬盘使用率|/alarm/collect/disk/used|influxdb:数据库配置,max:硬盘最高使用比例0-100|
|网络连接数|/alarm/collect/net/conn|influxdb:数据库配置,max:最大个数|
...
|nginx错误数|/alarm/collect/api/server/response|influxdb:数据库配置,max:最大个数|
|nginx每秒请求数|/alarm/collect/api/server/response|influxdb:数据库配置,max:最大个数|
